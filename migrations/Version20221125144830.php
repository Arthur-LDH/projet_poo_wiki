 ...
 */
final class Version20221125144830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , img CLOB DEFAULT NULL, CONSTRAINT FK_23A0E66F675F31B FOREIGN KEY (author_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_23A0E6626EF07C9 FOREIGN KEY (licence_id) REFERENCES licence (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD COLUMN date DATE NOT NULL');
    }
}
