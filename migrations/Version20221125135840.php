 ...
 */
final class Version20221125135840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , CONSTRAINT FK_23A0E66F675F31B FOREIGN KEY (author_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_23A0E6626EF07C9 FOREIGN KEY (licence_id) REFERENCES licence (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('ALTER TABLE console ADD COLUMN img CLOB DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, author_id, licence_id, name, description, content, date, created_at, updated_at FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, licence_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, content CLOB NOT NULL, date DATE NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, CONSTRAINT FK_23A0E66F675F31B FOREIGN KEY (author_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_23A0E6626EF07C9 FOREIGN KEY (licence_id) REFERENCES licence (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, author_id, licence_id, name, description, content, date, created_at, updated_at) SELECT id, author_id, licence_id, name, description, content, date, created_at, updated_at FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E66F675F31B ON article (author_id)');
        $this->addSql('CREATE INDEX IDX_23A0E6626EF07C9 ON article (licence_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__console AS SELECT id, name, created_at, updated_at FROM console');
        ...
        $this->addSql('INSERT INTO console (id, name, created_at, updated_at) SELECT id, name, created_at, updated_at FROM __temp__console');
